...
<body ng-app="myApp" ng-init="disable=false;rest_name='apnadhaba';total='<?php echo $_SESSION['bill'] ?>'">
	...
	Have a coupon?<input type="text" ng-model="coupon" ng-disabled="disable"><span ng-model="status"></span>{{status}}<button ng-show="cstatus" ng-click="cprocess()">Apply</button>
	<br />
	<br />
	<center><button ng-click="payment()">Proceed to Payment</button><center>
</div>
