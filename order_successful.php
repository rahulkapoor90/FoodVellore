...
$_SESSION['back'] = 2;
?>
<title>Order Successful, Yay!</title>
<?php
...
if(!isset($_SESSION['order_no'])){
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-sm-12">
				<h5>Thank You for using FOODONZ</h5>
			</div>
		</div>
		<div class="row">
			<div class="col-sm-12">
...
foreach($t as $ord){
  echo '<tr><td>'.$ord['itemname'].'</td><td>'.$ord['quantity'].'</td><td>'.$ord['price'].'</td></tr>';
}
echo '</table>  
			</div>
			</div>
...
Hey Congratulations! Your order is now being processed. <br>We hope you had an wonderful experience with us.</span>
</td>
</tr>
<tr>
...
$result = $mgClient->sendMessage($domain, array(
    'from'    => 'FoodONZ <no-reply@foodonz.com>',
    'to'      => 'rahulkapoorhooting@gmail.com,foodonz9@gmail.com',
    'subject' => 'Order Placed by Customer, '.$name1,
    'html'    => '<div bgcolor="#95a5a6" dir="ltr" style="margin:0;padding:0">
<table width="100%;" cellspacing="0" cellpadding="0" border="0" style="border-collapse:collapse">
<tbody>
...
<table class="table" style="font-size:15px">
  ...
  <tr><td>'.$ord['itemname'].'</td><td>'.$ord['quantity'].'</td><td>'.$ord['price'].'</td></tr>
				</table>
